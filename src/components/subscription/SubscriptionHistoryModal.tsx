...
export default function SubscriptionHistoryModal({
  ...
  const renderSubscriptionItem = useCallback(
    ({ item: subscription }: { item: IUserSubscriptionEntity }) => {
      const isUltra =
        subscription.subscriptionPlan.subscription.tagName === "ULTRA";
                ...
                {subscription.expiresAt === null ? (
                  <View style={styles.detailRow}>
                    ...
                    <View style={styles.detailContent}>
                      ...
                      <Text style={styles.detailValue}>
                        {t("subscription.lifetime_package", {
                          defaultValue: "Gói vĩnh viễn",
                        })}
                      </Text>
                    </View>
                  </View>
      ...
      return (
        <View style={styles.endContainer}>
          <Text style={styles.endText}>
            {t("subscription.end_of_list", {
              defaultValue: "Đã hiển thị tất cả",
            })}
          </Text>
        </View>
      );
      ...
      return (
        <View style={styles.emptyContainer}>
          <Text style={styles.emptyText}>
            {t("subscription.error_loading_history", {
              defaultValue: "Có lỗi xảy ra khi tải lịch sử",
            })}
          </Text>
          <TouchableOpacity
            onPress={() => refetch()}
      ...
      <View style={styles.emptyContainer}>
        <Text style={styles.emptyText}>
          {t("subscription.no_history", {
            defaultValue: "Chưa có lịch sử đăng ký",
          })}
        </Text>
      </View>
    );
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <Text style={styles.headerTitle}>
              {t("subscription.history_title", {
                defaultValue: "Lịch sử đăng ký",
              })}
            </Text>
